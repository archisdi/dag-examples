"""Rey Custom PostgreSQL to GCS operator."""
...
class CustomPostgresToGCSOperator(BaseSQLToGCSOperator):
    """
    ...
    def get_field_type(self, field) -> str:
        ...
        return self.type_map.get(field[1], "STRING")
    ...
    def convert_type(self, value, schema_type, stringify_dict=True):
        ...
        if isinstance(value, datetime.datetime):
            ...
            # -- THIS VALUE IS OVERRIDEN TO MAKE DATA TYPE TIMESTAMPS 
